 ...
 * @generated
 */
public class LcoreSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LcorePackage.XSTRUCTURAL_FEATURE: {
			...
			case LcorePackage.XTYPED_ELEMENT: {
