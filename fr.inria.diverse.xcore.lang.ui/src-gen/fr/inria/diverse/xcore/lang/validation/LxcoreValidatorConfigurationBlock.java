 ...
 */
package fr.inria.diverse.xcore.lang.validation;
...
public class LxcoreValidatorConfigurationBlock extends XbaseValidationConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(LxcoreConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Lxcore");
		if (section == null) {
			return dialogSettings.addNewSection("Lxcore");
		}
		return section;
	}
}
