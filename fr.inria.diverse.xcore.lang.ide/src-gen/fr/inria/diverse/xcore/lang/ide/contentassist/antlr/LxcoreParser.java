 ...
 */
package fr.inria.diverse.xcore.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.inria.diverse.xcore.lang.ide.contentassist.antlr.internal.InternalLxcoreParser;
import fr.inria.diverse.xcore.lang.services.LxcoreGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class LxcoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(LxcoreGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LxcoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getXClassAccess().getAlternatives_1(), "rule__XClass__Alternatives_1");
			builder.put(grammarAccess.getXMemberAccess().getAlternatives(), "rule__XMember__Alternatives");
			builder.put(grammarAccess.getXReferenceAccess().getAlternatives_1(), "rule__XReference__Alternatives_1");
			builder.put(grammarAccess.getXOperationAccess().getAlternatives_2(), "rule__XOperation__Alternatives_2");
			builder.put(grammarAccess.getXOperationAccess().getAlternatives_4(), "rule__XOperation__Alternatives_4");
			builder.put(grammarAccess.getXParameterAccess().getAlternatives_0(), "rule__XParameter__Alternatives_0");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_2(), "rule__XDataType__Group_2__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_2_2(), "rule__XDataType__Group_2_2__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_5_0(), "rule__XDataType__Group_5_0__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_5_1(), "rule__XDataType__Group_5_1__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup(), "rule__XEnum__Group__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup_3(), "rule__XEnum__Group_3__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup_3_1(), "rule__XEnum__Group_3_1__0");
			...
			builder.put(grammarAccess.getXClassAccess().getGroup_1_0(), "rule__XClass__Group_1_0__0");
			builder.put(grammarAccess.getXClassAccess().getGroup_3(), "rule__XClass__Group_3__0");
			builder.put(grammarAccess.getXClassAccess().getGroup_3_2(), "rule__XClass__Group_3_2__0");
			...
			builder.put(grammarAccess.getXAttributeAccess().getGroup_3(), "rule__XAttribute__Group_3__0");
			builder.put(grammarAccess.getXAttributeAccess().getGroup_4_0(), "rule__XAttribute__Group_4_0__0");
			builder.put(grammarAccess.getXAttributeAccess().getGroup_4_1(), "rule__XAttribute__Group_4_1__0");
			builder.put(grammarAccess.getXAttributeAccess().getGroup_4_2(), "rule__XAttribute__Group_4_2__0");
			builder.put(grammarAccess.getXAttributeAccess().getGroup_4_3(), "rule__XAttribute__Group_4_3__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup(), "rule__XReference__Group__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_0(), "rule__XReference__Group_1_0__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_1(), "rule__XReference__Group_1_1__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_2(), "rule__XReference__Group_1_2__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_3(), "rule__XReference__Group_1_3__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_4(), "rule__XReference__Group_1_4__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_1_5(), "rule__XReference__Group_1_5__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_5_0(), "rule__XReference__Group_5_0__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_5_1(), "rule__XReference__Group_5_1__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_5_2(), "rule__XReference__Group_5_2__0");
			builder.put(grammarAccess.getXReferenceAccess().getGroup_5_3(), "rule__XReference__Group_5_3__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup(), "rule__XOperation__Group__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_2_0(), "rule__XOperation__Group_2_0__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_2_1(), "rule__XOperation__Group_2_1__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_3(), "rule__XOperation__Group_3__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_3_2(), "rule__XOperation__Group_3_2__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_7(), "rule__XOperation__Group_7__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_7_1(), "rule__XOperation__Group_7_1__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_9(), "rule__XOperation__Group_9__0");
			builder.put(grammarAccess.getXOperationAccess().getGroup_9_2(), "rule__XOperation__Group_9_2__0");
			builder.put(grammarAccess.getXParameterAccess().getGroup(), "rule__XParameter__Group__0");
			builder.put(grammarAccess.getXParameterAccess().getGroup_0_0(), "rule__XParameter__Group_0_0__0");
			builder.put(grammarAccess.getXParameterAccess().getGroup_0_1(), "rule__XParameter__Group_0_1__0");
			builder.put(grammarAccess.getXTypeParameterAccess().getGroup(), "rule__XTypeParameter__Group__0");
			builder.put(grammarAccess.getXTypeParameterAccess().getGroup_1(), "rule__XTypeParameter__Group_1__0");
			builder.put(grammarAccess.getXTypeParameterAccess().getGroup_1_2(), "rule__XTypeParameter__Group_1_2__0");
			...
			builder.put(grammarAccess.getXPackageAccess().getImportDirectivesAssignment_3(), "rule__XPackage__ImportDirectivesAssignment_3");
			builder.put(grammarAccess.getXPackageAccess().getClassifiersAssignment_4(), "rule__XPackage__ClassifiersAssignment_4");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getTypeParametersAssignment_2_1(), "rule__XDataType__TypeParametersAssignment_2_1");
			builder.put(grammarAccess.getXDataTypeAccess().getTypeParametersAssignment_2_2_1(), "rule__XDataType__TypeParametersAssignment_2_2_1");
			builder.put(grammarAccess.getXDataTypeAccess().getInstanceTypeAssignment_4(), "rule__XDataType__InstanceTypeAssignment_4");
			builder.put(grammarAccess.getXDataTypeAccess().getSerializableAssignment_5_0_0(), "rule__XDataType__SerializableAssignment_5_0_0");
			builder.put(grammarAccess.getXDataTypeAccess().getCreateBodyAssignment_5_0_1(), "rule__XDataType__CreateBodyAssignment_5_0_1");
			builder.put(grammarAccess.getXDataTypeAccess().getConvertBodyAssignment_5_1_1(), "rule__XDataType__ConvertBodyAssignment_5_1_1");
			builder.put(grammarAccess.getXEnumAccess().getNameAssignment_1(), "rule__XEnum__NameAssignment_1");
			builder.put(grammarAccess.getXEnumAccess().getLiteralsAssignment_3_0(), "rule__XEnum__LiteralsAssignment_3_0");
			builder.put(grammarAccess.getXEnumAccess().getLiteralsAssignment_3_1_1(), "rule__XEnum__LiteralsAssignment_3_1_1");
			builder.put(grammarAccess.getXEnumLiteralAccess().getNameAssignment_0(), "rule__XEnumLiteral__NameAssignment_0");
			builder.put(grammarAccess.getXEnumLiteralAccess().getLiteralAssignment_1_1(), "rule__XEnumLiteral__LiteralAssignment_1_1");
			builder.put(grammarAccess.getXEnumLiteralAccess().getValueAssignment_2_1(), "rule__XEnumLiteral__ValueAssignment_2_1");
			builder.put(grammarAccess.getXClassAccess().getAbstractAssignment_1_0_0(), "rule__XClass__AbstractAssignment_1_0_0");
			builder.put(grammarAccess.getXClassAccess().getInterfaceAssignment_1_1(), "rule__XClass__InterfaceAssignment_1_1");
			builder.put(grammarAccess.getXClassAccess().getNameAssignment_2(), "rule__XClass__NameAssignment_2");
			builder.put(grammarAccess.getXClassAccess().getTypeParametersAssignment_3_1(), "rule__XClass__TypeParametersAssignment_3_1");
			builder.put(grammarAccess.getXClassAccess().getTypeParametersAssignment_3_2_1(), "rule__XClass__TypeParametersAssignment_3_2_1");
			builder.put(grammarAccess.getXClassAccess().getSuperTypesAssignment_4_1(), "rule__XClass__SuperTypesAssignment_4_1");
			builder.put(grammarAccess.getXClassAccess().getSuperTypesAssignment_4_2_1(), "rule__XClass__SuperTypesAssignment_4_2_1");
			builder.put(grammarAccess.getXClassAccess().getInstanceTypeAssignment_5_1(), "rule__XClass__InstanceTypeAssignment_5_1");
			builder.put(grammarAccess.getXClassAccess().getMembersAssignment_7(), "rule__XClass__MembersAssignment_7");
			builder.put(grammarAccess.getXAttributeAccess().getUnorderedAssignment_1_0(), "rule__XAttribute__UnorderedAssignment_1_0");
			builder.put(grammarAccess.getXAttributeAccess().getUniqueAssignment_1_1(), "rule__XAttribute__UniqueAssignment_1_1");
			builder.put(grammarAccess.getXAttributeAccess().getReadonlyAssignment_1_2(), "rule__XAttribute__ReadonlyAssignment_1_2");
			builder.put(grammarAccess.getXAttributeAccess().getTransientAssignment_1_3(), "rule__XAttribute__TransientAssignment_1_3");
			builder.put(grammarAccess.getXAttributeAccess().getVolatileAssignment_1_4(), "rule__XAttribute__VolatileAssignment_1_4");
			builder.put(grammarAccess.getXAttributeAccess().getUnsettableAssignment_1_5(), "rule__XAttribute__UnsettableAssignment_1_5");
			builder.put(grammarAccess.getXAttributeAccess().getDerivedAssignment_1_6(), "rule__XAttribute__DerivedAssignment_1_6");
			builder.put(grammarAccess.getXAttributeAccess().getIDAssignment_1_7(), "rule__XAttribute__IDAssignment_1_7");
			builder.put(grammarAccess.getXAttributeAccess().getNameAssignment_2(), "rule__XAttribute__NameAssignment_2");
			builder.put(grammarAccess.getXAttributeAccess().getDefaultValueLiteralAssignment_3_1(), "rule__XAttribute__DefaultValueLiteralAssignment_3_1");
			builder.put(grammarAccess.getXAttributeAccess().getGetBodyAssignment_4_0_1(), "rule__XAttribute__GetBodyAssignment_4_0_1");
			builder.put(grammarAccess.getXAttributeAccess().getSetBodyAssignment_4_1_1(), "rule__XAttribute__SetBodyAssignment_4_1_1");
			builder.put(grammarAccess.getXAttributeAccess().getIsSetBodyAssignment_4_2_1(), "rule__XAttribute__IsSetBodyAssignment_4_2_1");
			builder.put(grammarAccess.getXAttributeAccess().getUnsetBodyAssignment_4_3_1(), "rule__XAttribute__UnsetBodyAssignment_4_3_1");
			builder.put(grammarAccess.getXReferenceAccess().getContainmentAssignment_1_0_0(), "rule__XReference__ContainmentAssignment_1_0_0");
			builder.put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_0_1(), "rule__XReference__ResolveProxiesAssignment_1_0_1");
			builder.put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_1_0(), "rule__XReference__ResolveProxiesAssignment_1_1_0");
			builder.put(grammarAccess.getXReferenceAccess().getContainmentAssignment_1_1_1(), "rule__XReference__ContainmentAssignment_1_1_1");
			builder.put(grammarAccess.getXReferenceAccess().getContainerAssignment_1_2_0(), "rule__XReference__ContainerAssignment_1_2_0");
			builder.put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_2_1(), "rule__XReference__ResolveProxiesAssignment_1_2_1");
			builder.put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_3_0(), "rule__XReference__ResolveProxiesAssignment_1_3_0");
			builder.put(grammarAccess.getXReferenceAccess().getContainerAssignment_1_3_1(), "rule__XReference__ContainerAssignment_1_3_1");
			builder.put(grammarAccess.getXReferenceAccess().getLocalAssignment_1_4_1(), "rule__XReference__LocalAssignment_1_4_1");
			builder.put(grammarAccess.getXReferenceAccess().getLocalAssignment_1_5_0(), "rule__XReference__LocalAssignment_1_5_0");
			builder.put(grammarAccess.getXReferenceAccess().getUnorderedAssignment_2_0(), "rule__XReference__UnorderedAssignment_2_0");
			builder.put(grammarAccess.getXReferenceAccess().getUniqueAssignment_2_1(), "rule__XReference__UniqueAssignment_2_1");
			builder.put(grammarAccess.getXReferenceAccess().getReadonlyAssignment_2_2(), "rule__XReference__ReadonlyAssignment_2_2");
			builder.put(grammarAccess.getXReferenceAccess().getTransientAssignment_2_3(), "rule__XReference__TransientAssignment_2_3");
			builder.put(grammarAccess.getXReferenceAccess().getVolatileAssignment_2_4(), "rule__XReference__VolatileAssignment_2_4");
			builder.put(grammarAccess.getXReferenceAccess().getUnsettableAssignment_2_5(), "rule__XReference__UnsettableAssignment_2_5");
			builder.put(grammarAccess.getXReferenceAccess().getDerivedAssignment_2_6(), "rule__XReference__DerivedAssignment_2_6");
			builder.put(grammarAccess.getXReferenceAccess().getTypeAssignment_3(), "rule__XReference__TypeAssignment_3");
			builder.put(grammarAccess.getXReferenceAccess().getNameAssignment_4(), "rule__XReference__NameAssignment_4");
			builder.put(grammarAccess.getXReferenceAccess().getGetBodyAssignment_5_0_1(), "rule__XReference__GetBodyAssignment_5_0_1");
			builder.put(grammarAccess.getXReferenceAccess().getSetBodyAssignment_5_1_1(), "rule__XReference__SetBodyAssignment_5_1_1");
			builder.put(grammarAccess.getXReferenceAccess().getIsSetBodyAssignment_5_2_1(), "rule__XReference__IsSetBodyAssignment_5_2_1");
			builder.put(grammarAccess.getXReferenceAccess().getUnsetBodyAssignment_5_3_1(), "rule__XReference__UnsetBodyAssignment_5_3_1");
			builder.put(grammarAccess.getXOperationAccess().getUnorderedAssignment_2_0_0(), "rule__XOperation__UnorderedAssignment_2_0_0");
			builder.put(grammarAccess.getXOperationAccess().getUniqueAssignment_2_0_1(), "rule__XOperation__UniqueAssignment_2_0_1");
			builder.put(grammarAccess.getXOperationAccess().getUniqueAssignment_2_1_0(), "rule__XOperation__UniqueAssignment_2_1_0");
			builder.put(grammarAccess.getXOperationAccess().getUnorderedAssignment_2_1_1(), "rule__XOperation__UnorderedAssignment_2_1_1");
			builder.put(grammarAccess.getXOperationAccess().getTypeParametersAssignment_3_1(), "rule__XOperation__TypeParametersAssignment_3_1");
			builder.put(grammarAccess.getXOperationAccess().getTypeParametersAssignment_3_2_1(), "rule__XOperation__TypeParametersAssignment_3_2_1");
			builder.put(grammarAccess.getXOperationAccess().getTypeAssignment_4_0(), "rule__XOperation__TypeAssignment_4_0");
			builder.put(grammarAccess.getXOperationAccess().getNameAssignment_5(), "rule__XOperation__NameAssignment_5");
			builder.put(grammarAccess.getXOperationAccess().getParametersAssignment_7_0(), "rule__XOperation__ParametersAssignment_7_0");
			builder.put(grammarAccess.getXOperationAccess().getParametersAssignment_7_1_1(), "rule__XOperation__ParametersAssignment_7_1_1");
			builder.put(grammarAccess.getXOperationAccess().getExceptionsAssignment_9_1(), "rule__XOperation__ExceptionsAssignment_9_1");
			builder.put(grammarAccess.getXOperationAccess().getExceptionsAssignment_9_2_1(), "rule__XOperation__ExceptionsAssignment_9_2_1");
			builder.put(grammarAccess.getXOperationAccess().getBodyAssignment_10(), "rule__XOperation__BodyAssignment_10");
			builder.put(grammarAccess.getXParameterAccess().getUnorderedAssignment_0_0_0(), "rule__XParameter__UnorderedAssignment_0_0_0");
			builder.put(grammarAccess.getXParameterAccess().getUniqueAssignment_0_0_1(), "rule__XParameter__UniqueAssignment_0_0_1");
			builder.put(grammarAccess.getXParameterAccess().getUniqueAssignment_0_1_0(), "rule__XParameter__UniqueAssignment_0_1_0");
			builder.put(grammarAccess.getXParameterAccess().getUnorderedAssignment_0_1_1(), "rule__XParameter__UnorderedAssignment_0_1_1");
			builder.put(grammarAccess.getXParameterAccess().getTypeAssignment_1(), "rule__XParameter__TypeAssignment_1");
			builder.put(grammarAccess.getXParameterAccess().getNameAssignment_2(), "rule__XParameter__NameAssignment_2");
			builder.put(grammarAccess.getXTypeParameterAccess().getNameAssignment_0(), "rule__XTypeParameter__NameAssignment_0");
			builder.put(grammarAccess.getXTypeParameterAccess().getBoundsAssignment_1_1(), "rule__XTypeParameter__BoundsAssignment_1_1");
			builder.put(grammarAccess.getXTypeParameterAccess().getBoundsAssignment_1_2_1(), "rule__XTypeParameter__BoundsAssignment_1_2_1");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getUnorderedGroup_5(), "rule__XDataType__UnorderedGroup_5");
			builder.put(grammarAccess.getXAttributeAccess().getUnorderedGroup_1(), "rule__XAttribute__UnorderedGroup_1");
			builder.put(grammarAccess.getXAttributeAccess().getUnorderedGroup_4(), "rule__XAttribute__UnorderedGroup_4");
			builder.put(grammarAccess.getXReferenceAccess().getUnorderedGroup_2(), "rule__XReference__UnorderedGroup_2");
			builder.put(grammarAccess.getXReferenceAccess().getUnorderedGroup_5(), "rule__XReference__UnorderedGroup_5");
		}
	}
	...
	@Override
	protected InternalLxcoreParser createParser() {
		InternalLxcoreParser result = new InternalLxcoreParser(null);
