...
public class LxcoreSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LxcoreGrammarAccess grammarAccess;
	protected AbstractElementAlias match_XBlockExpression_SemicolonKeyword_2_1_q;
	protected AbstractElementAlias match_XEnum_CommaKeyword_3_1_0_q;
	protected AbstractElementAlias match_XExpressionInClosure_SemicolonKeyword_1_1_q;
	protected AbstractElementAlias match_XFunctionTypeRef___LeftParenthesisKeyword_0_0_RightParenthesisKeyword_0_2__q;
	protected AbstractElementAlias match_XGenericWildcardTypeArgument_QuestionMarkKeyword_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (LxcoreGrammarAccess) access;
		match_XBlockExpression_SemicolonKeyword_2_1_q = new TokenAlias(false, true, grammarAccess.getXBlockExpressionAccess().getSemicolonKeyword_2_1());
		match_XEnum_CommaKeyword_3_1_0_q = new TokenAlias(false, true, grammarAccess.getXEnumAccess().getCommaKeyword_3_1_0());
		match_XExpressionInClosure_SemicolonKeyword_1_1_q = new TokenAlias(false, true, grammarAccess.getXExpressionInClosureAccess().getSemicolonKeyword_1_1());
		match_XFunctionTypeRef___LeftParenthesisKeyword_0_0_RightParenthesisKeyword_0_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getXFunctionTypeRefAccess().getLeftParenthesisKeyword_0_0()), new TokenAlias(false, false, grammarAccess.getXFunctionTypeRefAccess().getRightParenthesisKeyword_0_2()));
		match_XGenericWildcardTypeArgument_QuestionMarkKeyword_1_q = new TokenAlias(false, true, grammarAccess.getXGenericWildcardTypeArgumentAccess().getQuestionMarkKeyword_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_XEnum_CommaKeyword_3_1_0_q.equals(syntax))
				emit_XEnum_CommaKeyword_3_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_XExpressionInClosure_SemicolonKeyword_1_1_q.equals(syntax))
				emit_XExpressionInClosure_SemicolonKeyword_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_XFunctionTypeRef___LeftParenthesisKeyword_0_0_RightParenthesisKeyword_0_2__q.equals(syntax))
				emit_XFunctionTypeRef___LeftParenthesisKeyword_0_0_RightParenthesisKeyword_0_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_XGenericWildcardTypeArgument_QuestionMarkKeyword_1_q.equals(syntax))
				emit_XGenericWildcardTypeArgument_QuestionMarkKeyword_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_XEnum_CommaKeyword_3_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_XGenericWildcardTypeArgument_QuestionMarkKeyword_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
